...
import BonusCalculationManagement from './pages/admin/BonusCalculationManagement'
import PayrollManagement from './pages/admin/PayrollManagement';
import PayrollUser from './pages/user/PayrollUser';

// Phase 7 컴포넌트
import DashboardReports from './pages/admin/DashboardReports';
import PerformanceTargetsManagement from './pages/admin/PerformanceTargetsManagement';

// 사용자 페이지 컴포넌트 import
import UserDashboard from './pages/user/Dashboard'
import MyProfile from './pages/user/MyProfile'
import StatisticsUser from './pages/user/StatisticsUser'
...
function ProtectedRoute({ children, requiredRole = null }) {
  ...
  // 일반 사용자는 user 역할이 필요한 페이지에만 접근 가능
  if (requiredRole === 'user' && user?.role === 'user') {
    return children
  }

  // 특정 역할이 필요하지 않은 경우 (공통 페이지)
  if (!requiredRole) {
    return children
  }
        ...
        <div className="min-h-screen bg-gray-50">
          <Routes>
            ...
            >
              ...
              <Route path="performance-targets" element={<PerformanceTargetsManagement />} />
              <Route path="performance-evaluation" element={<EvaluationManagement />} />
              <Route path="bonus-calculation" element={<BonusCalculationManagement />} />
