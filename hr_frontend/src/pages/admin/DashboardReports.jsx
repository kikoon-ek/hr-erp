...
const DashboardReports = () => {
  ...
  const { data: attendanceTrendData, isLoading: attendanceTrendLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await api.get('/dashboard/charts/attendance-trend');
      return response.data;
    }
  });
  ...
  const { data: departmentStatsData, isLoading: departmentStatsLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await api.get('/dashboard/charts/department-stats');
      return response.data;
    }
  });
  ...
  const { data: payrollTrendData, isLoading: payrollTrendLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await api.get('/dashboard/charts/payroll-trend');
      return response.data;
    }
  });
  ...
  const downloadReport = async (format) => {
    try {
      const response = await api.post('/dashboard/reports/download', {
        report_type: 'summary',
        format: format,
